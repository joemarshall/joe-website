...
permalink: /teaching/
---
# Project Ideas - Masters

Here are some project ideas for MSc summer projects

MSc students are also welcome to look at the undergrad projects below, but do be aware that some of them are quite technical and could potentially be quite meaty.

## Tracking people with VR Front Cameras

Modern virtual reality headsets have front mounted cameras which are primarily used to provide video passthrough. However it is also possible to do things on them, including computer vision. In this project, you will use the front cameras on a VR headset along with machine learning models to track people and implement some kind of interaction (a game, some way to interact with the headset wearer, whatever you decide). 

This project is relatively technical in that you will ahve to be comfortable coding for an Android device, either on Unity, Unreal or Godot engines. I'm not expecting anyone to implement the tracking models from scratch for this project, but running them involves a certain amount of programming.

## Physiotherapy Games

Build a game to support physiotherapy exercises. I'm kind of flexible as to what you do on this project, but I would recommend that you focus on a particular category of exercise and create a game that supports the exercise, either by visually tracking it (e.g. for a mobile or laptop based game using the onboard camera), or by tracking arm motion using controllers on a VR headset based game. Beyond the primary task of building a fun game you will need to consider how to ensure that people do the exercise with good form, how to adapt to differing levels of physical ability, whether you can measure ability and progress as people use the game etc.
...
## Asymmetric Mixed Reality Gaming

Traditional approaches to virtual reality assume that the user is immersed in a virtual world and does not care about what is going on outside. For this project you'll build a game where players wearing a VR headset must work with or play against people outside the headset. For example you might build a game of charades where the VR player has to act out something they see in the headset, or a game where the VR experience encourages people to move their body in a particular way, and the spectators have to interpret this somehow. Or if you're feeling technically minded you could make a networked smartphone and headset game. This idea is deliberately vague because I want *you* to have the game ideas and explore them. Similar to the above, game coding experience is pretty useful for this project.
